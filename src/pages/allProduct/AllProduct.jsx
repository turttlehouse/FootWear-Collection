    ...
    return (
        <Layout>
            <div className="py-8">
                {/* Heading  */}
                <div className="">
                    <h1 className="text-center mb-5 text-2xl font-semibold">Shop Our Shoes</h1>
                </div>
                                            ...
                                            <div className="p-6">
                                                ...
                                                <div className="flex justify-center">
                                                    {isAdmin ? (
                                                        // <button
                                                        //     disabled
                                                        //     className="bg-gray-400 text-white py-[4px] rounded-lg font-bold w-full cursor-not-allowed"
                                                        // >
                                                        <button>
